...
export const UserReducer = createReducer(initialState,
    ...
    on(UserActions.userLoginAction, (state, {payload}) => {return{...state, loading: true, success: false, message: null, code: null, loggedInUser: null}}),
    on(UserActions.userLoginResponseAction, (state, {response}) => {return {...state, loggedInUser: response.data, loading: false, success: response.success, message: response.message, code: response.code }}),
